    ...
    <FullWidthRectangle>
      <Paper sx={{ p: 3, width: '80%', maxWidth: 800, mb: 3 }}>
        ...
        <span style={{ textDecoration: 'underline' }}>Thorough Testing:</span>
         ...
         Maintain detailed documentation of port scan results, including identified vulnerabilities and recommended remediation steps, to support thorough analysis and reporting.<br />
